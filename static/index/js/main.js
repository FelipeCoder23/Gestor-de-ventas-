...
function editarPersonal(id, nombre, descripcion, precio_compra, precio_venta, proveedor, en_stock) {
  document.getElementById("id_producto_editar").value = id;
  document.getElementById("nombre_editar").value = nombre;
  document.getElementById("descripcion_editar").value = descripcion;
  document.getElementById("costo_editar").value = precio_compra;
  document.getElementById("precio_venta_editar").value = precio_venta;
  document.getElementById("proveedor_editar").value = proveedor;
  document.getElementById("cantidad_editar").value = en_stock;
}
...
function editarProducto(id, producto, cantidad) {
  document.getElementById("id_producto_editar").value = id;
